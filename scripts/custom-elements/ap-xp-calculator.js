import { PullCharacterList, UpdatedCalculateXp } from "./xp/3_5-xp.js";
export class XpCalculator extends HTMLElement {
    constructor() {
        super();
        this.enemiesInputs = [];
        this.selectedCharacters = {};
        this.dynamicElementIdCount = 0;
    ...
    BuildCharacterGroupHeader(groupName) {
        const header = document.createElement("h3");
        header.innerText = groupName;
        return header;
    }
    BuildCheckboxRow(characterName) {
    ...
    OnCheckboxClicked(characterName, checkbox) {
    ...
    CalculateExperience() {
        ...
        const enemies = this.enemiesInputs.map((enemyGroup) => ({
...
//# sourceMappingURL=ap-xp-calculator.js.map